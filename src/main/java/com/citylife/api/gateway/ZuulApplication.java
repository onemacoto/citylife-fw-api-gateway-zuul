...
import com.citylife.api.gateway.filter.ModifyHeaderFilter;
import com.citylife.api.gateway.filter.ZuulErrorFilter;
...
public class ZuulApplication {
	...
	@Bean
	public ModifyHeaderFilter modifyHeaderFilter() {
		return new ModifyHeaderFilter();
	}
